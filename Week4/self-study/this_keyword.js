...
// ******attention
//if arrow function is a callback function in another function then it has acess to parent scope ,and this keyword in arrow function refers object in this case refers object user
...
const user2={    //in this example arrow function can cnot access oject scoope  
...
const user3={     //in here arrow function inherit the nearest parent function scope
    ...
    fullname:function(){
     ...
     arrowFunction();  //this call invokes the arrow function and arrow funtion access the parent scope and this key word refers object Alex
}
}
user3.fullname()
